...
Version 1.2.3 introduces a **Modular Domain Expansion**. The library is structured into five distinct categories to cover the entire lifecycle of global trade physics.
...
Plaintext
Asif, K. S. (2026). phytrade: Institutional Physics Library for Global Commodity Arbitration (v1.2.3).

...
[![CI](https://github.com/<OWNER>/<REPOSITORY>/actions/workflows/ci.yml/badge.svg?branch=<BRANCH>)](https://github.com/<OWNER>/<REPOSITORY>/actions/workflows/ci.yml)

[![CodeQL](https://github.com/<OWNER>/<REPOSITORY>/actions/workflows/codeql.yml/badge.svg?branch=<BRANCH>)](https://github.com/<OWNER>/<REPOSITORY>/actions/workflows/codeql.yml)

[![Security](https://github.com/<OWNER>/<REPOSITORY>/actions/workflows/security.yml/badge.svg?branch=<BRANCH>)](https://github.com/<OWNER>/<REPOSITORY>/actions/workflows/security.yml)

[![Lint](https://github.com/<OWNER>/<REPOSITORY>/actions/workflows/lint.yml/badge.svg?branch=<BRANCH>)](https://github.com/<OWNER>/<REPOSITORY>/actions/workflows/lint.yml)

[![Tests](https://github.com/<OWNER>/<REPOSITORY>/actions/workflows/tests.yml/badge.svg?branch=<BRANCH>)](https://github.com/<OWNER>/<REPOSITORY>/actions/workflows/tests.yml)

[![Coverage](https://github.com/<OWNER>/<REPOSITORY>/actions/workflows/coverage.yml/badge.svg?branch=<BRANCH>)](https://github.com/<OWNER>/<REPOSITORY>/actions/workflows/coverage.yml)

[![Documentation](https://github.com/<OWNER>/<REPOSITORY>/actions/workflows/docs.yml/badge.svg?branch=<BRANCH>)](https://github.com/<OWNER>/<REPOSITORY>/actions/workflows/docs.yml)

[![Build](https://github.com/<OWNER>/<REPOSITORY>/actions/workflows/build.yml/badge.svg?branch=<BRANCH>)](https://github.com/<OWNER>/<REPOSITORY>/actions/workflows/build.yml)

[![Release](https://github.com/<OWNER>/<REPOSITORY>/actions/workflows/release.yml/badge.svg?branch=<BRANCH>)](https://github.com/<OWNER>/<REPOSITORY>/actions/workflows/release.yml)

[![Publish](https://github.com/<OWNER>/<REPOSITORY>/actions/workflows/publish.yml/badge.svg?branch=<BRANCH>)](https://github.com/<OWNER>/<REPOSITORY>/actions/workflows/publish.yml)

[![PyPI Publish](https://github.com/<OWNER>/<REPOSITORY>/actions/workflows/pypi.yml/badge.svg?branch=<BRANCH>)](https://github.com/<OWNER>/<REPOSITORY>/actions/workflows/pypi.yml)

[![Dependency Review](https://github.com/<OWNER>/<REPOSITORY>/actions/workflows/dependency-review.yml/badge.svg?branch=<BRANCH>)](https://github.com/<OWNER>/<REPOSITORY>/actions/workflows/dependency-review.yml)

[![Pages](https://github.com/<OWNER>/<REPOSITORY>/actions/workflows/pages.yml/badge.svg?branch=<BRANCH>)](https://github.com/<OWNER>/<REPOSITORY>/actions/workflows/pages.yml)

<!-- ========================= -->
<!-- PyPI -->
<!-- ========================= -->

[![PyPI Version](https://img.shields.io/pypi/v/<PYPI_PACKAGE>.svg)](https://pypi.org/project/<PYPI_PACKAGE>/)

[![Python Version](https://img.shields.io/pypi/pyversions/<PYPI_PACKAGE>.svg)](https://pypi.org/project/<PYPI_PACKAGE>/)

[![Downloads](https://img.shields.io/pypi/dm/<PYPI_PACKAGE>.svg)](https://pypi.org/project/<PYPI_PACKAGE>/)
...
[![GitHub Release](https://img.shields.io/github/v/release/<OWNER>/<REPOSITORY>)](https://github.com/<OWNER>/<REPOSITORY>/releases)

[![GitHub Stars](https://img.shields.io/github/stars/<OWNER>/<REPOSITORY>)](https://github.com/<OWNER>/<REPOSITORY>/stargazers)

[![GitHub Forks](https://img.shields.io/github/forks/<OWNER>/<REPOSITORY>)](https://github.com/<OWNER>/<REPOSITORY>/network)

[![GitHub Watchers](https://img.shields.io/github/watchers/<OWNER>/<REPOSITORY>)](https://github.com/<OWNER>/<REPOSITORY>/watchers)

[![Issues](https://img.shields.io/github/issues/<OWNER>/<REPOSITORY>)](https://github.com/<OWNER>/<REPOSITORY>/issues)

[![Pull Requests](https://img.shields.io/github/issues-pr/<OWNER>/<REPOSITORY>)](https://github.com/<OWNER>/<REPOSITORY>/pulls)

[![Contributors](https://img.shields.io/github/contributors/<OWNER>/<REPOSITORY>)](https://github.com/<OWNER>/<REPOSITORY>/graphs/contributors)

[![Last Commit](https://img.shields.io/github/last-commit/<OWNER>/<REPOSITORY>)](https://github.com/<OWNER>/<REPOSITORY>/commits/<BRANCH>)

[![Commit Activity](https://img.shields.io/github/commit-activity/m/<OWNER>/<REPOSITORY>)](https://github.com/<OWNER>/<REPOSITORY>/graphs/commit-activity)

<!-- ========================= -->
<!-- Coverage -->
<!-- ========================= -->

[![Codecov](https://codecov.io/gh/<OWNER>/<REPOSITORY>/branch/<BRANCH>/graph/badge.svg)](https://codecov.io/gh/<OWNER>/<REPOSITORY>)

<!-- ========================= -->
<!-- Security -->
<!-- ========================= -->

[![OpenSSF Scorecard](https://api.securityscorecards.dev/projects/github.com/<OWNER>/<REPOSITORY>/badge)](https://securityscorecards.dev/viewer/?uri=github.com/<OWNER>/<REPOSITORY>)
...
[![Documentation](https://readthedocs.org/projects/<DOCS_PROJECT>/badge/?version=latest)](https://<DOCS_PROJECT>.readthedocs.io/)

[![GitHub Pages](https://img.shields.io/badge/docs-GitHub%20Pages-blue)](https://<OWNER>.github.io/<REPOSITORY>/)
...
[![Cite](https://img.shields.io/badge/Citation-CITATION.cff-blue)](CITATION.cff)

[![ORCID](https://img.shields.io/badge/ORCID-0000--0000--0000--0000-A6CE39?logo=orcid)](https://orcid.org/<0000-0003-0560-9117>)
